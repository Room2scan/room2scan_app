...
export const ALL_FURNITURE: FurnitureItem[] = [
  { id: 'f1', name: 'NORDLI Chest', type: 'Dresser', dimensions: '120×80 cm', price: '₩249,000', thumbnail: 'package', color: '#FFFFFF', isWishlisted: true, rating: 4.7 },
  ...
  { id: 'f3', name: 'LACK Table', type: 'Table', dimensions: '55×55 cm', price: '₩15,000', thumbnail: 'grid', color: '#4A3AFF', isWishlisted: false, rating: 4.5 },
  { id: 'f4', name: 'KALLAX Shelf', type: 'Shelf', dimensions: '77×147 cm', price: '₩129,000', thumbnail: 'layers', color: '#EAE8FF', isWishlisted: true, rating: 4.8 },
  { id: 'f5', name: 'MALM Bed Frame', type: 'Bed', dimensions: '160×200 cm', price: '₩349,000', thumbnail: 'moon', color: '#D9DBE9', isWishlisted: false, rating: 4.6 },
  ...
  { id: 'f7', name: 'BILLY Bookcase', type: 'Shelf', dimensions: '80×202 cm', price: '₩89,000', thumbnail: 'book-open', color: '#F1F2F9', isWishlisted: true, rating: 4.8 },
  { id: 'f8', name: 'HEMNES Dresser', type: 'Dresser', dimensions: '108×96 cm', price: '₩299,000', thumbnail: 'package', color: '#EAE8FF', isWishlisted: false, rating: 4.7 },
  { id: 'f9', name: 'EKTORP Sofa', type: 'Sofa', dimensions: '235×88 cm', price: '₩599,000', thumbnail: 'home', color: '#D9DBE9', isWishlisted: true, rating: 4.9 },
  { id: 'f10', name: 'FRIHETEN Sofa', type: 'Sofa', dimensions: '230×151 cm', price: '₩699,000', thumbnail: 'home', color: '#897FFF', isWishlisted: false, rating: 4.6 },
  { id: 'mf1', name: '내 소파 (스캔)', type: 'Sofa', dimensions: '210×90 cm', price: '직접 스캔', thumbnail: 'home', color: '#4A3AFF', isWishlisted: false, rating: 5.0, isMyFurniture: true },
  { id: 'mf2', name: '원목 책상 (스캔)', type: 'Table', dimensions: '140×70 cm', price: '직접 스캔', thumbnail: 'grid', color: '#897FFF', isWishlisted: false, rating: 5.0, isMyFurniture: true },
];
...
export const MY_ROOMS: RoomProject[] = [
  {
    ...
    furniture: [
      { id: 'rf1', name: 'MALM Bed Frame', thumbnail: 'moon', dimensions: '160×200 cm', x: 20, y: 15, rotation: 0 },
      { id: 'rf2', name: 'NORDLI Chest', thumbnail: 'package', dimensions: '120×80 cm', x: 60, y: 20, rotation: 90 },
  ...
  },
  {
    ...
    furniture: [
      { id: 'rf4', name: 'EKTORP Sofa', thumbnail: 'home', dimensions: '235×88 cm', x: 25, y: 60, rotation: 0 },
      { id: 'rf5', name: 'LACK Table', thumbnail: 'grid', dimensions: '55×55 cm', x: 50, y: 45, rotation: 0 },
      { id: 'rf6', name: 'BILLY Bookcase', thumbnail: 'book-open', dimensions: '80×202 cm', x: 10, y: 20, rotation: 0 },
    ],
  },
  {
    ...
    furniture: [
      { id: 'rf7', name: '원목 책상 (스캔)', thumbnail: 'grid', dimensions: '140×70 cm', x: 30, y: 30, rotation: 0 },
      { id: 'rf8', name: 'KALLAX Shelf', thumbnail: 'layers', dimensions: '77×147 cm', x: 70, y: 15, rotation: 0 },
    ],
  },
];
