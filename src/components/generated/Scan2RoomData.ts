import { FurnitureItem, RoomProject, HeroBanner, CatalogCategory } from './Scan2RoomTypes';
...
export const MY_ROOMS: RoomProject[] = [{
  ...
  realPhotos: ['https://images.unsplash.com/photo-1505693314120-0d443867891c?w=400&q=75', 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=400&q=75'],
  furniture: [{
    id: 'rf1',
    name: 'MALM Bed Frame',
    thumbnail: '🛏️',
  ...
  realPhotos: ['https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=400&q=75', 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=400&q=75'],
  furniture: [{
    id: 'rf4',
    name: 'EKTORP Sofa',
    thumbnail: '🛋️',
  ...
  realPhotos: ['https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=400&q=75', 'https://images.unsplash.com/photo-1547119957-637f8679db1e?w=400&q=75'],
  furniture: [{
    id: 'rf7',
    name: '원목 책상 (스캔)',
    thumbnail: '🪵',
...
export const HERO_BANNERS: HeroBanner[] = [{
  ...
  ctaText: '둘러보기',
  overlayFrom: 'rgba(10,20,40,0.55)',
  overlayTo: 'rgba(0,0,0,0.0)'
}, {
  id: 'b3',
  label: '소파 컬렉션',
